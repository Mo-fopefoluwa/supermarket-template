...
const Home = () => {
  ...
  return (
    <Layout>
      ...
      <section className="w-full my-6 px-4 md:px-8">
        <div className="w-full flex items-center justify-between">
          <p className="text-base md:text-2xl font-semibold capitalize text-[#22305f] relative before:absolute before:rounded-lg before:content before:w-14 before:md:w-32 before:h-1 before:-bottom-2 before:left-0 before:bg-gradient-to-tr from-[#ff7518] to-[#c44e00] transition-all ease-in-out duration-100">
            Our BestSellers
          </p>
          <div className="hidden md:flex gap-3 items-center">
            <motion.div
      ...
      <section className="w-full my-6 px-4 md:px-8">
        <div className="w-full flex items-center justify-between">
          <p className="text-base md:text-2xl font-semibold capitalize text-[#22305f] relative before:absolute before:rounded-lg before:content before:w-16 before:md:w-26 before:h-1 before:-bottom-2 before:left-0 before:bg-gradient-to-tr from-[#ff7518] to-[#c44e00] transition-all ease-in-out duration-100">
